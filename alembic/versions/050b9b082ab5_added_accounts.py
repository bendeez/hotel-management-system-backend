...
def upgrade() -> None:
    ...
    op.add_column("business", sa.Column("type", sa.Integer(), nullable=False))
    op.create_foreign_key(None, "business", "types", ["type"], ["id"])
    op.add_column("users", sa.Column("type", sa.Integer(), nullable=False))
    op.create_foreign_key(None, "users", "types", ["type"], ["id"])
