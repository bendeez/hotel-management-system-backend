...
def upgrade() -> None:
    ...
    op.add_column('business_users', sa.Column('role_name', sa.String(length=45), nullable=False))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('business_users', sa.Column('role_id', mysql.INTEGER(), autoincrement=False, nullable=False))
