...
def upgrade() -> None:
    ...
    op.drop_constraint("business_ibfk_1", "domain", type_="foreignkey")
    op.create_foreign_key(
        None, "domain", "accounts", ["id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        None, "business_data", "domain", ["business_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        None, "business_users", "domain", ["business_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, "business_users", type_="foreignkey")
    op.create_foreign_key(
        "business_users_ibfk_2", "business_users", "domain", ["business_id"], ["id"]
    )
    op.create_foreign_key(
    ...
    op.drop_constraint(None, "business_data", type_="foreignkey")
    op.create_foreign_key(
        "business_data_ibfk_1", "business_data", "domain", ["business_id"], ["id"]
    )
    op.create_foreign_key(
    ...
    op.create_foreign_key("business_ibfk_1", "domain", "accounts", ["id"], ["id"])
    # ### end Alembic commands ###
