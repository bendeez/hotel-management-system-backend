...
from app.accounts.schemas import UserAccountOut, BusinessAccountOut, BusinessUserAccountCreate
...
async def add_account_to_business(business_user: BusinessUserAccountCreate,
                                  account: Account = Depends(get_account),
                                  account_service: AccountsService = Depends(AccountsService)):
    business_user_account = await account_service.create_business_user_account(account=account, business_user=business_user)
