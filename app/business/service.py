...
class BusinessService:
    ...
    async def delete_business_account(self, account: Accounts):
        ...
        return DeleteResponse(message=f"Business account {account.email} has been deleted")
    ...
    async def delete_business_user_account(
        ...
        return DeleteResponse(message=f"Business user account {account.email} has been deleted")
