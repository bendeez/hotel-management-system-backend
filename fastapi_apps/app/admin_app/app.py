...
from app.admin_app.facility.application.endpoints import facility_router
from app.admin_app.chat.application.endpoints import chat_router
from app.admin_app.business.application.endpoints import business_router
from app.admin_app.auth.application.endpoints import auth_router
from app.admin_app.user.application.endpoints import user_router
