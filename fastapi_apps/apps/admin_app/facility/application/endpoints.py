...
from apps.admin_app.facility.domain.schemas import FacilityCreate, FacilityOut
...
from apps.admin_app.facility.application.dependencies import get_facility_service
